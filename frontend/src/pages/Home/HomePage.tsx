      ...
      <section className="text-center py-12 md:py-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/auth/register">
            <Button label="Înregistrare" variant="primary" size="lg" />
          </Link>
          <Link to="/auth/login">
            <Button label="Autentificare" variant="outline" size="lg" />
          </Link>
        </div>
      </section>
      ...
      <section className="py-12 w-full max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Planifică colectarea deșeurilor și primește notificări automate pentru evenimente
              importante.
            </p>
          </div>
        </div>
