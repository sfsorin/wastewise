  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-primary-600 dark:text-primary-400">Misiunea noastră</h2>
        <p className="text-lg mb-4 text-gray-700 dark:text-gray-300">
          WasteWise este o platformă inovatoare dedicată îmbunătățirii managementului deșeurilor prin 
          tehnologie și date. Misiunea noastră este să transformăm modul în care organizațiile gestionează 
          deșeurile, făcând procesul mai eficient, transparent și sustenabil.
        </p>
        <p className="text-lg text-gray-700 dark:text-gray-300">
          Prin soluțiile noastre digitale, ajutăm companiile și autoritățile publice să monitorizeze, 
          analizeze și optimizeze procesele de colectare și procesare a deșeurilor, contribuind la 
          reducerea impactului asupra mediului și la promovarea economiei circulare.
        </p>
      </section>
      
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-primary-600 dark:text-primary-400">Echipa noastră</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Echipa noastră tehnică combină cunoștințe avansate în dezvoltare software, 
              analiză de date și inteligență artificială pentru a crea soluții robuste și scalabile.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Colaborăm cu experți în managementul deșeurilor și protecția mediului pentru 
              a ne asigura că soluțiile noastre respectă cele mai bune practici din domeniu.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-primary-600 dark:text-primary-400">Tehnologii utilizate</h2>
        <p className="text-lg mb-6 text-gray-700 dark:text-gray-300">
