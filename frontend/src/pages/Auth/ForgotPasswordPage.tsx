...
const ForgotPasswordPage = () => {
    ...
    return (
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          Am trimis un email la adresa <strong>{email}</strong> cu instrucțiuni pentru resetarea
          parolei.
        </p>

        <div className="flex flex-col space-y-4">
          <Link to="/auth/login">
            <Button label="Înapoi la autentificare" variant="primary" className="w-full" />
          </Link>
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-6">
        Introduceți adresa de email asociată contului dumneavoastră și vă vom trimite un link pentru
        resetarea parolei.
      </p>
