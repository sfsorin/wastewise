  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400">Gestionați preferințele contului dumneavoastră</p>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Primiți notificări prin email pentru activități importante</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Primiți notificări push în browser pentru actualizări în timp real</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Primiți notificări prin SMS pentru alerte urgente</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Primiți un raport săptămânal cu statistici și activități</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Primiți un raport lunar detaliat cu analize și recomandări</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
          ...
          <div className="space-y-6">
            <div>
              ...
              >
                ...
                <option value="contacts">Contacte - Vizibil doar pentru contactele dumneavoastră</option>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Permiteți partajarea datelor anonimizate pentru îmbunătățirea serviciului</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
